...
$First_name=$Last_name=$Contact_No=$Email=$password = $confirm_password= $Checker_Id=$Department_Name="";
$First_Name_err=$Last_name_err=$Contact_No_err=$Email_err=$password_err = $confirm_password_err=$Checker_Id_err=
$Department_Name_err ="";
if(isset($_POST['save']))
{	 
	...
	if (empty($_POST['Last_name'])) {
			...
			if (empty($_POST['Contact_No'])) {
				...
				if (empty($_POST['Checker_Id'])) {
					$Checker_Id_err=  "Ckecker ID  is required" ;
					}else{
	 ...
	 && empty($Checker_Id_err) && empty($Department_Name_err ))
	 {
...
<link rel="stylesheet" type="text/css" href="style.css">
  ...
  <body>
  <!--action="Proceecheck.php"-->
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
	<div class="CheckerReg">
	<h1>Checker Registration</h1>
	<div class="form-group <?php echo (!empty($First_Name_err)) ? 'has-error' : ''; ?>">
		...
		<div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
			...
			<div class="form-group <?php echo (!empty($Checker_Id_err)) ? 'has-error' : ''; ?>">
                <label>Checker ID</label>
                <input type="Text" name="Checker_Id" class="form-control" value="<?php echo $Checker_Id; ?>">
                <span class="help-block"><?php echo $Checker_Id_err; ?></span>
            </div>
